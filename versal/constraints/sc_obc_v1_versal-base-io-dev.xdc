...
#-----------------------------------------------------------------------------
# SC-OBC Module V1: Versal pin constraints for Developer's Grade
#-----------------------------------------------------------------------------
...
# Clock Signals
set_property [get_ports DDR4_CK_*]       -dict {IOSTANDARD DIFF_SSTL12 SLEW MEDIUM OUTPUT_IMPEDANCE RDRV_40_40            OFFSET_CNTRL CNTRL_NONE}
# Address and Command Signals
set_property [get_ports {DDR4_A[*]}]     -dict {IOSTANDARD SSTL12      SLEW MEDIUM OUTPUT_IMPEDANCE RDRV_40_40            OFFSET_CNTRL CNTRL_NONE}
set_property [get_ports DDR4_BG]         -dict {IOSTANDARD SSTL12      SLEW MEDIUM OUTPUT_IMPEDANCE RDRV_40_40            OFFSET_CNTRL CNTRL_NONE}
set_property [get_ports {DDR4_BA[*]}]    -dict {IOSTANDARD SSTL12      SLEW MEDIUM OUTPUT_IMPEDANCE RDRV_40_40            OFFSET_CNTRL CNTRL_NONE}
set_property [get_ports DDR4_ACT_N]      -dict {IOSTANDARD SSTL12      SLEW MEDIUM OUTPUT_IMPEDANCE RDRV_40_40            OFFSET_CNTRL CNTRL_NONE}
set_property [get_ports DDR4_PARITY]     -dict {IOSTANDARD SSTL12      SLEW MEDIUM OUTPUT_IMPEDANCE RDRV_40_40            OFFSET_CNTRL CNTRL_NONE}
set_property [get_ports DDR4_RESET_N]    -dict {IOSTANDARD LVCMOS12    SLEW SLOW                                                                                                              DRIVE 8}
# Control Signals
set_property [get_ports DDR4_CKE]        -dict {IOSTANDARD SSTL12      SLEW MEDIUM OUTPUT_IMPEDANCE RDRV_40_40            OFFSET_CNTRL CNTRL_NONE}
set_property [get_ports DDR4_CS_N]       -dict {IOSTANDARD SSTL12      SLEW MEDIUM OUTPUT_IMPEDANCE RDRV_40_40            OFFSET_CNTRL CNTRL_NONE}
set_property [get_ports DDR4_ODT]        -dict {IOSTANDARD SSTL12      SLEW MEDIUM OUTPUT_IMPEDANCE RDRV_40_40            OFFSET_CNTRL CNTRL_NONE}
# Data Signals
